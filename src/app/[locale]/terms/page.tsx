      ...
      <main className="flex-1">
        ...
        >
          ...
          <div className="relative mx-auto max-w-7xl px-6">
            {/* ShieldAlert Icon */}
            <div className="inline-flex h-14 w-14 items-center justify-center rounded-2xl bg-amber-50 text-amber-600 mb-5 shadow-inner border border-amber-100">
              <Scale className="h-7 w-7" />
            </div>

            <span className="block text-amber-600 text-sm font-bold tracking-wider mb-3 uppercase">
              {t("badge")}
            </span>
          ...
          <div className="mx-auto max-w-7xl px-6 flex flex-col lg:flex-row gap-10">
                    ...
                    {sections.map((sec, i) => {
                      ...
                      return (
                        ...
                        >
                          ...
                          {isActive && (
                            <ChevronRight className="h-3.5 w-3.5 ml-auto text-amber-500 shrink-0" />
                          )}
                        </button>
                      );
                    })}
            ...
            <div className="flex-1 min-w-0 space-y-6">
              ...
              <div className="bg-[#1a1a2e] rounded-2xl p-8 md:p-10 relative overflow-hidden">
                ...
                <div className="absolute bottom-0 left-0 h-48 w-48 rounded-full bg-rose-500/10 blur-3xl" />
                ...
                <div className="relative z-10 flex flex-col md:flex-row items-start md:items-center gap-6">
                  ...
                  <div className="flex-1">
                    ...
                    <a
                      ...
                      className="text-amber-400 text-[14px] font-semibold hover:text-amber-300 transition-colors"
                    >
                      {t("contactEmail")}
                    </a>
                  </div>
