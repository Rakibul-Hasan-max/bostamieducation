  ...
  const handleGoogleSignup = async () => {
    ...
    try {
      ...
      if (err?.code === "auth/popup-closed-by-user") {
        setErrorMsg("Sign-up popup was closed before completing.");
        ...
        <div className="w-full max-w-[540px]">
          <div className="mb-8">
            <h2 className="text-[28px] font-bold text-slate-900 mb-2.5 flex items-center gap-2">
              <span role="img" aria-label="wave">👋</span> Sign up to Bostami Education!
            </h2>
            <p className="text-slate-500 text-[14px]">
              Nice to see you! Please enter your details to create an account.
            </p>
          </div>

          {errorMsg && (
            <div className="mb-5 flex items-start gap-2.5 rounded-lg bg-red-50 border border-red-200 p-3.5 text-[13px] text-red-600">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <button 
              ...
              className="flex items-center justify-center gap-2 rounded-lg bg-[#4285F4] hover:bg-[#3367d6] disabled:opacity-70 text-white py-2.5 text-[13px] font-medium transition-colors cursor-pointer"
            >
              {googleLoading ? (
              ...
              {googleLoading ? "Signing up..." : "Signup with Google"}
            </button>
            <button 
              type="button" 
              className="flex items-center justify-center gap-2 rounded-lg bg-slate-700 hover:bg-slate-800 text-white py-2.5 text-[13px] font-medium transition-colors cursor-pointer"
            >
