...
export default function CoursesPage() {
  ...
  const coursesData: Course[] = COURSES_DATA.map((course) => ({
    id: course.id,
    title: t.has(course.titleKey) ? t(course.titleKey) : course.defaultTitle,
                  ...
                  >
                    ...
                    <div className="p-5 flex-1 flex flex-col justify-between">
                      <div>
                        ...
                        {/* Title */}
                        <h3 className="text-[15px] font-bold text-slate-900 leading-snug line-clamp-2 mb-4 group-hover:text-blue-600 transition-colors">
                          {course.title}
                        </h3>
                      </div>
